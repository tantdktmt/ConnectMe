...
public class UseCaseHandler {
    ...
    private static UseCaseHandler SINGLE_HANDLER;
    ...
    private <V extends UseCase.ResponseValue> void notifyError(Throwable t,
                                                               final UseCase.UseCaseCallback<V> useCaseCallback) {
    ...
    public static synchronized UseCaseHandler getSingleHandler() {
        if (SINGLE_HANDLER == null) {
            SINGLE_HANDLER = new UseCaseHandler(new UseCaseSingleThreadScheduler());
        }
